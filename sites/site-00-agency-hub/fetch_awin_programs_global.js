...
// Removing the relationship=joined filter to see ALL available programs
const options = {
    hostname: 'api.awin.com',
    path: `/publishers/${API_CONFIG.publisherId}/programmes`,
    method: 'GET',
    headers: {
...
console.log(`[*] Fetching ALL available programs for Publisher ${API_CONFIG.publisherId}...`);
    ...
    res.on('end', () => {
        try {
            ...
            if (Array.isArray(programs)) {
                const dataPath = path.join(__dirname, 'awin_programs_directory.json');
